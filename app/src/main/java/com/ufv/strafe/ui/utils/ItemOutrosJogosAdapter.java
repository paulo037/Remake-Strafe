...
public class ItemOutrosJogosAdapter extends RecyclerView.Adapter<ItemOutrosJogosAdapter.ViewItemJogarHolder> {


    private ArrayList<Integer> icons;


    public ItemOutrosJogosAdapter(ArrayList<Integer> icons){
        this.icons = icons;
    }
